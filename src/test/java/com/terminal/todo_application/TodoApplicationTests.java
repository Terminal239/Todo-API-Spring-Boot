...
class TodoApplicationTests {
	...
	public void shouldReturnTodoWithGivenId() throws Exception {
		...
		String response = mockMvc.perform(post("/api/todo")
						.contentType(MediaType.APPLICATION_JSON)
						.content(objectMapper.writeValueAsString(todo)))
		...
		mockMvc.perform(get("/api/todo/" + createdTodo.getId()))
				.andExpect(status().isOk())
				.andExpect(content().contentType(MediaType.APPLICATION_JSON))
	...
	public void shouldToggleTodoCompletion() throws Exception {
		...
		mockMvc.perform(patch("/api/todo/" + createdTodo.getId() + "/completion"))
				.andExpect(status().isOk())
				.andExpect(content().contentType(MediaType.APPLICATION_JSON))
	...
	public void shouldDeleteTodo() throws Exception {
		...
		mockMvc.perform(delete("/api/todo/" + createdTodo.getId()))
